...
public class UnitSpawnEditor : Editor
{
    protected virtual void OnSceneGUI()
    {
        UnitSpawn example = (UnitSpawn)target;
        ...
        {
            Handles.color = Color.black;
			UnityEditor.Handles.Label( (Vector3)(example.transform.TransformPoint(formationPositions[i])), i.ToString());
