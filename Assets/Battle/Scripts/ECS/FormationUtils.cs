...
namespace UnitAgent
{
    ...
    public static class FormationUtils
    {
        ...
        public static readonly float UnitColumnWidth = 20, UnitRowHeight = 6;
        ...
        public static float3[] CalcUnitFormations()
        {
            ...
            {
                formationOffsets[f * UnitOffsetsPerFormation + i] = new float3(i * UnitColumnWidth, 0, i * UnitRowHeight);
            }
            ...
            for (int i = 0; i < UnitOffsetsPerFormation; i++)
            {
                ...
                formationOffsets[f * UnitOffsetsPerFormation + i] = new float3(col * UnitColumnWidth, 0, row * UnitRowHeight);
            }
        ...
        public static float3[] CalcAgentFormations()
        {
            ...
            {
                formationOffsets[f * AgentOffsetsPerFormation + i] = new float3(i * AgentColumnWidth, 0, i * AgentRowHeight);
            }
            ...
            for (int i = 0; i < AgentOffsetsPerFormation; i++)
            {
                ...
                formationOffsets[f * AgentOffsetsPerFormation + i] = new float3(col * AgentColumnWidth, 0, row * AgentRowHeight);
            }
